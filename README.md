...
1. Clone the repo
   ```sh
   git clone https://github.com/skec13/react_investmentCalculator.git
   ```
...
Project Link: [https://github.com/skec13/react_investmentCalculator](https://github.com/skec13/react_investmentCalculator)
